...
void book_pre_teens() {
  ...
  case 2:
    ...
    break;
  case 3:
    printf("Aqui estao livros de ficcao cientifca: \n\n");
    for (int iterator = 0; iterator < BOOKS; iterator++) {
      printf("%s\n\n", books_scifi[iterator]);
    }
    break;
  case 4:
    printf("Aqui estao livros de drama realista: \n\n");
    for (int iterator = 0; iterator < BOOKS; iterator++) {
...
void book_teens() {
  ...
  case 1:
    ...
    break;
  case 2:
    printf("Aqui estao livros de mistério: \n\n");
    for (int iterator = 0; iterator < BOOKS; iterator++) {
      printf("%s\n\n", books_mystery[iterator]);
    }
    break;
  case 3:
    printf("Aqui estao livros de ficcao cientifica: \n\n");
    for (int iterator = 0; iterator < BOOKS; iterator++) {
      printf("%s\n\n", books_scifi[iterator]);
    }
    break;
...
void registrationOptions() {
  ...
  switch (age) {
  case 1:
    printf("Otimo, iremos exibir livros para crianças de 4 a 9 anos\n\n");
    book_childrens();
    break;
  case 2:
    ...
    break;
  case 3:
    printf("Otimo, iremos exibir livros para adolescentes de 14 a 18 anos\n\n");
    book_teens();
    break;
  default:
    return;
